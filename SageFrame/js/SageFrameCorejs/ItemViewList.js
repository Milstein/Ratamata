    ...
    if (data.d.length > 0) {
        ...
        $.each(data.d, function (index, value) {
            ...
            //if (allowWishListLatestItem.toLowerCase() == 'true') {
                ...
                html += "<div class='classWishlist'><div class=\"cssClassWishListButton\"><input type=\"hidden\" name=\"itemwish\"  value='" + value.ItemID + ',' + JSON2.stringify(xx) + ',' + JSON2.stringify(value.SKU) + ",this' /></div></div>";
            //}
            html += '</div>';
