...
<script language="javascript" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(pwdID).on("change", function() {
            ...
            if (len < 4 && len != 0) {
                $(this).after('<label class="sfError " id="lblPassswordLength"><br/>*</label>');
                return false;
            }
            else {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvConfirmPasswordRequired" runat="server" ControlToValidate="ConfirmPassword"
                                Display="Dynamic" ErrorMessage="ewew" ValidationGroup="CreateUserWizard1" CssClass="sfError"
                            ...
                            <asp:CompareValidator ID="cvPasswordCompare" runat="server" ControlToCompare="Password"
                                ControlToValidate="ConfirmPassword" Display="Dynamic" ErrorMessage="Passwords must match" ValidationGroup="CreateUserWizard1"
                                CssClass="sfError sfErrorBlock" meta:resourcekey="cvPasswordCompareResource1"></asp:CompareValidator>
                        </td>
                    </tr>
