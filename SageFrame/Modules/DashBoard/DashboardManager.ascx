        ...
        var DashboardMgr = {
            ...
            TabIconUploader: function () {
                ...
                var upload = new AjaxUpload($('#fupTabIcon'), {
                    action: DashboardMgr.config.Path + 'UploadHandler.ashx?' + DashboardMgr.config.userModuleId + '&portalID=' + SageFramePortalID + '&userName=' + SageFrameUserName + '&secureToken=' + SageFrameSecureToken,
                    name: 'myfile[]',
                    multiple: false,
                    data: {},
                    autoSubmit: true,
