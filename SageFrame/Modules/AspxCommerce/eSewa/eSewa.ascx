<%@ Control Language="C#" AutoEventWireup="true" CodeFile="eSewa.ascx.cs" Inherits="Modules_AspxeSewa_eSewa" %>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var AspxOrder = {
            ...
            init: function() {
                $('#btneSewa').live("click", function() {
                    ...
                    if ($('#SingleCheckOut').length > 0) {
                        ...
                        AspxOrder.SendDataForPaymenteSewa();
                    }
                });
            },
            ajaxSuccess: function(data) {
                switch (AspxOrder.config.ajaxCallMode) {
                    ...
                    case 3:
                        ...
                        AspxOrder.SetSessionValue("eSewaData", x);
                        document.location = '<%=PatheSewa%>' + "PayThrougheSewa.aspx";
                        break;
                    case 4:
                        var x = AspxCommerce.utils.GetStoreID() + "#" + AspxCommerce.utils.GetPortalID() + "#" + AspxCommerce.utils.GetUserName() + "#" + AspxCommerce.utils.GetCustomerID() + "#" + AspxCommerce.utils.GetSessionCode() + "#" + AspxCommerce.utils.GetCultureName();
                        var itemIds = "";
            ...
            SendDataForPaymenteSewa: function() {
                ...
                var paymentMethodName = "eSewa";
                var paymentMethodCode = "eSewa";
...
<input type="button" id="btneSewa" class="sfLocale" value="Place Order (eSewa)" />
