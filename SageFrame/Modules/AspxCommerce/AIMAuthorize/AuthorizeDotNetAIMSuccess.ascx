    ...
    <div id="divPageOuter" class="PageOuter">
        ...
        <div id="divClickAway">
            <div class="sfButtonwrapper">
                <asp:HyperLink ID="hlnkHomePage" runat="server" meta:resourcekey="hlnkHomePageResource1"
        ...
        <div id="divPage" class="Page" runat="server">
            ...
            <table id="tablePaymentDetails2Rcpt" cellspacing="0" cellpadding="0" width="75%">
                <tr>
                    <td>
                    ...
                    <td class="DataColInfo1R">
                        <asp:Label ID="lblOrderNo" runat="server"
                            meta:resourcekey="lblOrderNoResource1"></asp:Label>
                    </td>
                    <td colspan="2"></td>
                </tr>
                <tr>
            ...
            <table class="PaymentSectionTable" cellspacing="0" cellpadding="0" width="50%">
                <tr>
