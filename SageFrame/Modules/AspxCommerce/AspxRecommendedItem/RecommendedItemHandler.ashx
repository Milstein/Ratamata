<%@ WebHandler Language="C#" Class="RecommendedItemHandler" %>
...
public class RecommendedItemHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.RecommendedItem.RecommendedItemController), json, methodName);
