    ...
    ItemMangement = {
        ...
        GiftCard: function () {
            ...
            var bindGiftCartCategory = function (data) {
                ...
                var options1 = '<option value="0" selected="selected" >' + getLocale(AspxItemsManagement, "All") + '</option>';
                var options;
        ...
        SaveItemCostVariantsInfo: function (itemId) {
            ItemMangement.SaveItemCostVariant(itemId);
        },

        SaveItemCostVariant: function (itemId) {
            var CostVariantCombinationList = [];
            var i = 0;
            var totalQuantity = 0;
            ...
            ItemMangement.AddItemCostVariantInfo(ItemsCostVariant);
        },
        ...
        EditItems: function (tblID, argus) {
            ...
            switch (tblID) {
                case "gdvItems":
                    ...
                    if (itemTypeId != 5) {
                        ItemMangement.InitCostVariantCombination(argus[0], true);
        ...
        CreateForm: function (itemFormFields, attributeSetId, itemTypeId, showDeleteBtn, itemId) {
            ...
            if (itemTypeId == 1 || itemTypeId == 2) {
                ItemMangement.GetAllBrandForItem();
                if (itemId > 0) {
                    ItemMangement.GetBrandByItemID(itemId);
                }
            }
            if (itemId > 0) {
            ...
            if (p.EnableRelatedItem == true) {
                ItemMangement.BindRelatedItemsGrid(itemId, null, null, null, null);
            }
            if (p.EnableUpSellItem == true) {
                ItemMangement.BindUpSellItemsGrid(itemId, null, null, null, null);
            }
            if (p.EnableCrossSellItem == true) {
                ItemMangement.BindCrossSellItemsGrid(itemId, null, null, null, null);
            }
        ...
        InitCostVariantCombination: function (itemId, isEdit) {
            $("#dvCvForm").on("change", ".ddlCostVariantsCollection", function () {
                ...
                ItemMangement.GetCostVariantValues(this.value, elem);


            });
            $("#btnCancelCostVariantCombination").off("click").on("click", function () {
                ItemMangement.ResetCVHtml();
            });
            ...
            $("#btnDeleteCostVariantCombination").off("click").on("click", function () {
                var properties = {
                    onComplete: function (e) {
                        if (e) {
                            $(".cssClassItemQuantity").removeAttr("disabled", "disabled");
                            ItemMangement.DeleteCostVariantCombination();
                        }
                    }
                };
                csscody.confirm("<h2>" + getLocale(AspxItemsManagement, 'Delete Confirmation') + "</h2><p>" + getLocale(AspxItemsManagement, 'Are you sure you want to delete this Cost Variant Combination?') + "</p>", properties);
            ...
            ItemMangement.ResetCVHtml(false, '');
        ...
        CreateCombinations: function (index, costvarId, costVarValueId) {
            ...
            ItemMangement.GetCostVariantValues(costvarId, elem);
                    ...
                    if (msg.d.length > 0) {
                        ...
                        $.each(msg.d, function (index, item) {
                            ...
                            for (var id = 0; id < len; id++) {
                                ItemMangement.CreateCombinations(id, ids[id], vids[id]);
                            }
                        });
        ...
        DeleteCostVariantCombination: function () {
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    ItemMangement.ResetCVHtml(true, alertMsg);
                },
                error: function () {
        ...
        ResetCVHtml: function (showMsg, alertMsg) {
            ...
            ItemMangement.GetAllCostVariants(showMsg, alertMsg);
        },
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.d.length > 0) {
                        ...
                        ItemMangement.BindCostVariantsOfItem(showMsg, alertMsg);
                    } else {
                        $(".cssClassTableCostVariant:first").find(".ddlCostVariantsCollection").html(options);
                    }
            ...
            switch (ItemMangement.config.ajaxCallMode) {
                ...
                case 20:
                    ...
                    if (itemId > 0) {
                        ...
                        if (itemTypeId != 5) {
                            ItemMangement.InitCostVariantCombination($("#ItemMgt_itemID").val(), !($("#ItemMgt_itemID").val() == 0));
                ...
                case 27:
                    ...
                    if ($("#ItemMgt_itemID").val() == 0) {
                        showPopup = false;
                        if ($("#dvCvForm>table").attr('style')) {
                            if (!$("#dvCvForm>table").attr('style').contains('none')) {
                                var variantsProperties = $("#dvCvForm table:first>tbody>tr>td.cssClassTableCostVariant").find("input.cssClassDisplayOrder,input.cssClassVariantValueName, .ddlCostVariantsCollection, .ddlCostVariantValues");
                                var isEmpty = false;
                                $.each(variantsProperties, function (index, item) {
                                    if ($.trim($(this).val()) == 0) {
                                ...
                                if (!isEmpty) {
                                    ItemMangement.SaveItemCostVariantsInfo(id);
                                }
                            }
                        }
                        if ($("#tblQuantityDiscount").parents('div.sfFormwrapper:eq(0)').attr('style')) {
