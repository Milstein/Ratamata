                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        ...
                        <tr class="cssClassAvailableTime" style="display: none">
                            ...
                            <td>
                                <div class="cssClassTimeList" style="width: 200px; height: 120px; overflow: auto;
                                    background: #C8BFE1">
            ...
            <div id="dvPlaceOrder" class="cssClassOrderReview">
                <div class="sfButtonwrapper ">
                    <%-- <button id="btnPlaceBack" type="button" value="back" class="back">
                            <span><span class="sfLocale">Back</span></span></button>--%>
                    <button id="btnPlaceOrder" type="button" class="submit sfBtn">
                        <span class="sfLocale icon-order">Place Order</span></button>
                </div>
            </div>
        </div>
    </div>
