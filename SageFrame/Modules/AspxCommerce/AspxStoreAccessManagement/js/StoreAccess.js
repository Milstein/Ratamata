               ...
               $('#btnDeleteSelectedIP,#btnDeleteSelectedDomain,#btnDeleteSelectedEmail,#btnDeleteSelectedCreditCard,#btnDeleteSelectedCustomer').click(function() {
                   ...
                   switch ($(this).prop('id')) {
                       case "btnDeleteSelectedIP":
                           attribute_ids = SageData.Get("gdvIP").Arr.join(',');
                       ...
                       case "btnDeleteSelectedDomain":
                           attribute_ids = SageData.Get("gdvDomain").Arr.join(',');
                           if (attribute_ids.length>0) {
                               var properties = {
                                   onComplete: function(e) {
                                       StoreAccessmanage.ConfirmDeleteMultiple(attribute_ids, e);
                       ...
                       case "btnDeleteSelectedEmail":
                           attribute_ids = SageData.Get("gdvEmail").Arr.join(',');
                           if (attribute_ids.length>0) {
                               var properties = {
                                   onComplete: function(e) {
                                       StoreAccessmanage.ConfirmDeleteMultiple(attribute_ids, e);
                       ...
                       case "btnDeleteSelectedCreditCard":
                           attribute_ids = SageData.Get("gdvCreditCard").Arr.join(',');
                           if (attribute_ids.length > 0) {
                               var properties = {
                                   onComplete: function(e) {
                                       StoreAccessmanage.ConfirmDeleteMultiple(attribute_ids, e);
                       ...
                       case "btnDeleteSelectedCustomer":
                           attribute_ids = SageData.Get("gdvCustomer").Arr.join(',');
                           if (attribute_ids.length > 0) {
                               var properties = {
                                   onComplete: function(e) {
                                       StoreAccessmanage.ConfirmDeleteMultiple(attribute_ids, e);
                       ...
                       case "btnAddEmail":
                           ...
                           ShowPopupControl("popuprel");                           $('#txtStoreAccessValue').autocomplete({
                               source: function(req, res) {
                                   $.ajax({
                                       url: aspxservicePath + "AspxCoreHandler.ashx/GetAspxUserEmail",
                       ...
                       case "btnAddCustomer":
                           ...
                           $('#txtStoreAccessValue').autocomplete({
                               source: function(request, response) {
                                   $.ajax({
                                       url: aspxservicePath + "AspxCoreHandler.ashx/GetAspxUser",
           ...
           CheckEmail: function() {
               switch (StoreAccessKeyID) {
                   case "3":
                       ...
                       $.ajax({
                           url: aspxservicePath + "AspxCoreHandler.ashx/CheckEmailAddress",
