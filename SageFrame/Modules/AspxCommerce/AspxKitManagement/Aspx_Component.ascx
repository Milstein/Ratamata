...
<div id="dvKits">
    ...
    <div class="cssClassHeader">
        <h1>
            <asp:Label ID="lblTitle" runat="server" Text="Kit Management"></asp:Label>
        </h1>
...
<div id="dvEditKit" style="display: none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblCouponManageTitle" Text="Save Kit" runat="server"></asp:Label>
            </h1>
        </div>
        <div class="sfFormwrapper">
            <table border="0" width="100%" id="" class="cssClassPadding">
                <tr>
                    <td>
                        <asp:Label ID="lblKitName" Text="Kit Name:" runat="server" CssClass="cssClassLabel"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" Text="Default Price:" runat="server" CssClass="cssClassLabel"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" Text="Default Quantity:" runat="server" CssClass="cssClassLabel"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label3" Text="Default Weight:" runat="server" CssClass="cssClassLabel"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" Text="Choose KitComponent:" runat="server" CssClass="cssClassLabel"></asp:Label>
                    </td>
                    <td>
