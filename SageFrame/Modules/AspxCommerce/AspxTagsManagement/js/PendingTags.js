        ...
        PendingTags = {
            ...
            BindResults: function() {
                ...
                $.each(arrTagItemsToBind, function(index, value) {
                    ...
                    if (istrue != 0) {
                        ...
                        tagItems += '<div class="cssClassGrid3Picture"><img height="81" width="123" src="' + aspxRootPath + value.BaseImage + '" alt="' + value.AlternateText + '" title="' + value.Name + '" /></div>';
            ...
            ajaxSuccess: function(data) {
                ...
                case 5:
                    ...
                    $.each(data.d, function(index, item) {
                        tableElements += '<tr>';
                        tableElements += '<td><img height="81" width="100" src="' + aspxRootPath + item.BaseImage + '" alt="' + item.AlternateText + '" title="' + item.Name + '" /></td>';
