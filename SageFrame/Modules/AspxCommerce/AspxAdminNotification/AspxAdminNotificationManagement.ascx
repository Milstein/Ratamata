...
<div id="divAsxpABTesting">
    <div class="cssClassCommonBox Curve">
        ...
        <div class="sfButtonwrapper sftype1">
                <label id="btnSaveNotificationSettings" class="sfSave sfLocale sfBtn icon-save">Save</label>
                <label id="btnRefrershNotificationSettings" class="sfRefresh sfLocale sfBtn icon-refresh">Refresh</label>
            </div>
    </div>
</div>
