<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonalizationRecentlyViewedItem.ascx.cs" Inherits="Modules_AspxCommerce_AspxPersonalization_PersonalizationRecentlyViewedItem" %>
