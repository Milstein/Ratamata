<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonalizationLatestItems.ascx.cs" Inherits="Modules_AspxCommerce_AspxPersonalization_PersonalizationLatestItems" %>
