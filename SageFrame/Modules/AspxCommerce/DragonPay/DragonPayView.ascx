<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DragonPayView.ascx.cs" Inherits="Modules_DragonPay_DragonPayView" %>
<script type="text/javascript">
    ...
    $(function() {
        ...
        var AspxOrder = {
            ...
            init: function() {
                $('#btnDragonPay').live("click", function() {
                    ...
                    if ($('#SingleCheckOut').length > 0) {
                        ...
                        AspxOrder.SendDataForPaymentDragonPay();
                    }
                });
            },
            ajaxSuccess: function(data) {
                switch (AspxOrder.config.ajaxCallMode) {
                    ...
                    case 3:
                        ...
                        AspxOrder.SetSessionValue("DragonPayData", x);
                        document.location = '<%=PathDragonPay%>' + "PayThrougDragonPay.aspx";
                        break;
                    case 4:
                        var x = AspxCommerce.utils.GetStoreID() + "#" + AspxCommerce.utils.GetPortalID() + "#" + AspxCommerce.utils.GetUserName() + "#" + AspxCommerce.utils.GetCustomerID() + "#" + AspxCommerce.utils.GetSessionCode() + "#" + AspxCommerce.utils.GetCultureName();
                        var itemIds = "";
            ...
            SendDataForPaymentDragonPay: function() {
                ...
                var paymentMethodName = "DragonPay";
                var paymentMethodCode = "DragonPay";
...
<input type="button" id="btnDragonPay" class="sfLocale" value="Place Order (DragonPay)" />