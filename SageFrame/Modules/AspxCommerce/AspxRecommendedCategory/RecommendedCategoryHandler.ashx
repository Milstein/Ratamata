<%@ WebHandler Language="C#" Class="RecommendedCategoryHandler" %>
...
public class RecommendedCategoryHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.RecommendedCategory.RecommendCategoryController), json, methodName);
