...
$(function () {
    ...
    UpdateStoreSettings: function () {
        ...
        settingValues += maximumImageSize + '*' + maximumDownloadSize + '*' + ItemLargeThumbnailImageHeight + '*' + ItemLargeThumbnailImageWidth + '*' + ItemMediumThumbnailImageHeight
        ...
        settingKeys += 'MaximumImageSize' + '*' + 'MaxDownloadFileSize' + '*' + 'ItemLargeThumbnailImageHeight' + '*' + 'ItemLargeThumbnailImageWidth' + '*' + 'ItemMediumThumbnailImageHeight'
