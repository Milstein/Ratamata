    ...
    $.AdvanceSearchView = function (p) {
        ...
        var AdvanceSearch = {
            ...
            BindItemsByDyanamicAdvanceSearch: function (msg) {
                ...
                BindTemplateDetails('divShowAdvanceSearchResult', 'divItemViewOptions', 'divViewAs', 'ddlAdvanceSearchViewAs', 'ddlAdvanceSearchSortBy', 'divSearchPageNumber', 'Pagination', 'ddlPageSize', currentPage, msg, AdvanceSearch.ShowSearchResult, 'AdvanceSearch', p.AllowAddToCart, p.AllowOutStockPurchaseSetting,
            ...
            Init: function () {
                ...
                createDropDown('ddlAdvanceSearchSortBy', 'divSortBy', 'sortBy', p.Displaymode);
                createDropDown('ddlAdvanceSearchViewAs', 'divViewAs', 'viewAs', p.Displaymode);
                $("#lstBrands").val('0');
                $("#ddlAdvanceSearchViewAs").on("change", function () {
                    BindResults('divShowAdvanceSearchResult', "divViewAs", 'ddlAdvanceSearchViewAs', null, p.AllowOutStockPurchaseSetting, p.NoImageAdSearchPathSetting, p.NoOfItemsInRow, p.Displaymode);
                });
                ...
                $("#ddlCategory").change(function () {
                    arry = [];
                    var isGiftCard = false;
                    $(".cssDyanamicAttributes").remove();
                    var categoryID = $(this).val();
                    if ($("#ddlCategory option:selected").attr("isgiftcard") != undefined)
                        isGiftCard = $("#ddlCategory option:selected").attr("isgiftcard");
                    AdvanceSearch.GetAllBrandForItem(categoryID, isGiftCard);
                    if (categoryID != 0)
                        AdvanceSearch.GetShoppingFilter(categoryID, isGiftCard);
                });
