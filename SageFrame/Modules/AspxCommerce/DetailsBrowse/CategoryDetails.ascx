                ...
                if (msg.d.length > 0) {
                    ...
                    $.each(msg.d, function (index, value) {
                        if (value.CategoryImage != '') {
                            ...
                            headerWrapper += "<div class=\"cat-slide-container-inner\"><div class=\"cssCatImage\"><a href=" + href + "><img src='" + aspxRootPath + catImagePath + "' alt='" + value.CategoryName + "' title='" + value.CategoryName + "' /></a></div><div class=\"cssCatDesc\"><span>" + value.CategoryName + "</span><p>" + catDesc + "</p></div></div>";
                        }
                    });
                    headerWrapper += "</div>";
