      ...
      WishList = {
          ...
          ajaxSuccess: function(msg) {
              switch (WishList.config.ajaxCallMode) {
                  case 1:
                      HeaderControl.GetWishListCount();                      WishList.GetWishItemList();                      csscody.info("<h2>"+getLocale(AspxWishList,"Successful Message")+"</h2><p>"+getLocale(AspxWishList,"Wished item has been deleted successfully.")+"</p>");
                      break;
                  case 2:
