    ...
    $.WishItemsListSettingSetting = function (param) {
        ...
        wishItemsSettings = {
            ...
            BindWishItemsSetting: function () {               
                $("#chkEnableWishItems").prop("checked", p.IsEnableWishList)
            ...
            WishItemsSettingUpdate: function () {
                var isEnableWishList = $("#chkEnableWishItems").prop("checked");
                ...
                var settingKeys = "IsEnableWishList*IsEnableImageInWishlist*NoOfRecentAddedWishItems*WishListPageName";
                var settingValues = isEnableWishList + "*" + isEnableImageInWishlist + "*" + noOfRecentAddedWishItems + "*" + wishListPageName;
