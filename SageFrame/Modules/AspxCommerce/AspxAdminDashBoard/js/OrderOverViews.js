                ...
                case 1:
                    if (msg.d.length > 0) {
                        ...
                        $.each(msg.d, function(index, value) {
                            ...
                            bodyElements += '<td><label class="cssClassLabel">' + value.TotalOrder + '</label></td>';
                            bodyElements += '<td><label class="cssClassLabel cssClassFormatCurrency">' + value.TotalAmount + '</label></td>';
                            bodyElements += '</tr>';
