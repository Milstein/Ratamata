...
var WishItemAPI = function () {
    ...
    var wishListURL = "";
    var getLocalized = function () {

        var path = aspxRootPath + "Modules/AspxCommerce/AspxWishList/Language/AspxWishItems.js"
        if (SageFrameCurrentCulture != 'en-US') {
            path = aspxRootPath + "Modules/AspxCommerce/AspxWishList/Language/AspxWishItems." + SageFrameCurrentCulture + ".js";
        }
        //script executed globally
        $.getScript(path).done(function (script, textStatus) {
        }).fail(function (jqxhr, settings, exception) {
            //console.log("Selected Localization not found.");
        });
    };
