...
$(function() {
    ...
    OrderStatusMgmt = {
        ...
        BindOrdersStatusInGrid: function(OrderSatatusName, isAct) {
            ...
            this.config.data = { aspxCommonObj: aspxCommonObj, orderStatusName: OrderSatatusName, isActive: isAct };
        ...
        CheckOrderStatusUniquness: function(orderStatusId) {
            ...
            this.config.url = this.config.baseURL + this.config.method;
            this.config.data = JSON2.stringify({ aspxCommonObj: aspxCommonObj, orderStatusId: orderStatusId, orderStatusAliasName: orderStatusName });
