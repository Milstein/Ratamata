...
<div id="divEnterAddress" visible="false">
    <div>
        ...
        <div id="divFrontStoreButton" class="sfButtonwrapper cssClassFrontStoreButton">
            <button type="button" id="btnSubmitSearchAddress" class="sfBtn">
                <span class="sfLocale icon-search">Search</span></button>
            <button type="button" id="btnShowAllStore" class="sfBtn">
                <span class="sfLocale icon-showall">Show all Stores</span></button>
