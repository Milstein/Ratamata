    ...
    RecentHistory = {
        ...
        GetUserRecentlyViewedItems: function () {
            ...
            $("#gdvRecentlyViewedItems").sagegrid({
                ...
                colModel: [
                    { display: 'RecentlyViewedID', name: 'recentlyViewedID', cssclass: 'cssClassHeadCheckBox', coltype: 'checkbox', align: 'center', elemClass: 'recentlyViewedItemsChkbox', elemDefault: false, controlclass: 'itemsHeaderChkbox' },
        ...
        GetUserRecentlyComparedItems: function () {
            ...
            $("#gdvRecentlyComparedItems").sagegrid({
                ...
                colModel: [
                    { display: 'RecentlyComparedItemID', name: 'recentlyComparedItemID', cssclass: 'cssClassHeadCheckBox', coltype: 'checkbox', align: 'center', elemClass: 'recentlyComparedItemsChkbox', elemDefault: false, controlclass: 'itemsHeaderChkbox' },
