...
var primaryCode = currencyCode; function AddMoreVariantOptions(obj) {
...
function AddCombinationListRow(obj) {
    ...
    $(".cssClassTableCostVariant:last").find(".ddlCostVariantValues").html("<option value='0'>" + getLocale(AspxUserDashBoard, "No values") + "</option>").removeAttr("disabled").prop("enabled", "enabled");
...
$(function() {
    ...
    UserDashBoardItemMangement = {
        ...
        init: function() {
            ...
            $('#dynItemForm').on('click', '#btnReturn', function() {
        ...
        BindItemsGrid: function(sku, Nm, itemType, attributeSetNm, visibility, isAct) {
            ...
            $("#gdvItems").sagegrid({
                ...
                { display: getLocale(AspxUserDashBoard, 'Active?'), name: 'status', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left' },
        ...
        BindRelatedItemsGrid: function(selfItemID, itemSKU, itemName, itemTypeID, attributeSetID) {
            ...
            UserDashBoardItemMangement.GetRelatedCheckIDs(selfItemID);
        },
        ...
        BindUpSellItemsGrid: function(selfItemID, itemSKU, itemName, itemTypeID, attributeSetID) {
            ...
            $("#gdvUpSellItems").sagegrid({
             ...
             UserDashBoardItemMangement.GetUpSellCheckIDs(selfItemID);
        },
        ...
        BindCrossSellItemsGrid: function(selfItemID, itemSKU, itemName, itemTypeID, attributeSetID) {
            ...
            UserDashBoardItemMangement.GetCrossSellCheckIDs(selfItemID);
        },
        ...
        + '_' + item.IsIncludeInPriceRule + '_' + item.DisplayOrder;
            ...
            var val = '';
                ...
                case 1:                    if (item.ValidationTypeID == 3) {
                    ...
                    break;
                case 3:                    if (item.DateValue == "1/1/1900 12:00:00 AM") {
                        $("#" + id).val("");
                    }
                    else {
                        $("#" + id).val(formatDate(new Date(item.DateValue), "yyyy/MM/dd"));
                                                          ...
                                                          break;
                case 4:                    if (item.BooleanValue.toLowerCase() == "true") {
        ...
        DeleteImage: function(onjImg) {            $(onjImg).parent().parent().remove();
            $("#multipleUpload .classTableWrapper > tbody tr").removeClass("sfEven");
            $("#multipleUpload .classTableWrapper > tbody tr").removeClass("sfOdd");
            $("#multipleUpload .classTableWrapper > tbody tr:even").addClass("sfEven");
            $("#multipleUpload .classTableWrapper > tbody tr:odd").addClass("sfOdd");
            ...
            $('#dvCvForm').on('click', '.classAddImages', function() {
                ...
                if (listImages[value] != null && listImages[value] != "") {
                    ...
                    $.each(subStr, function(index) {
                        List += '<tr>';
                        List += '<td><img src="' + aspxRootPath + "Modules/AspxCommerce/AspxUserDashBoard/uploads/" + subStr[index] + '" class="uploadImage" height="100px" width="125px"/></td>';
        ...
        createRow: function(itemId, itemTypeId, attID, attName, attType, attTypeValue, attDefVal, attToolTip, attLen, attValType, isEditor, isUnique, isRequired, groupId, isIncludeInPriceRule, displayOrder) {
            ...
            switch (attType) {
                ...
                case 9:                    if (attTypeValue.length > 0) {
                    ...
                    break;
                case 10:                    retString += '<td class="cssClassTableRightCol"><div class="cssClassRadioBtn ' + UserDashBoardItemMangement.GetValidationTypeClasses(attValType, isUnique, isRequired) + '">'
                    for (var i = 0; i < attTypeValue.length; i++) {
                        var val = attTypeValue[i];
                        if (val.isdefault == 1) {
                    ...
                    retString += '<span class="iferror">' + UserDashBoardItemMangement.GetValidationTypeErrorMessage(attValType) + '</span></div></td>';
                    break;
                case 11:                    retString += '<td class="cssClassTableRightCol"><div class="cssClassCheckBox ' + UserDashBoardItemMangement.GetValidationTypeClasses(attValType, isUnique, isRequired) + '">';
                    if (attTypeValue.length > 0) {
                        for (var i = 0; i < attTypeValue.length; i++) {
                            var val = attTypeValue[i];
                            if (val.isdefault == 1) {
                    ...
                    retString += '<span class="iferror">' + UserDashBoardItemMangement.GetValidationTypeErrorMessage(attValType) + '</span></div></td>';
                    break;
                case 12:                    retString += '<td class="cssClassTableRightCol"><div class="cssClassCheckBox ' + UserDashBoardItemMangement.GetValidationTypeClasses(attValType, isUnique, isRequired) + '">';
                    if (attTypeValue.length > 0) {
                        for (var i = 0; i < attTypeValue.length; i++) {
                            var val = attTypeValue[i];
                            if (val.isdefault == 1) {
        ...
        GetValidationTypeErrorMessage: function(attValType) {
            var retString = ''
            switch (attValType) {
                case 1:                    retString = getLocale(AspxUserDashBoard, "Alphabets Only");
                    break;
                case 2:                    retString = getLocale(AspxUserDashBoard, "AlphaNumeric");
                    break;
                case 3:                    retString = getLocale(AspxUserDashBoard, "Decimal Number");
                    break;
                case 4:                    retString = getLocale(AspxUserDashBoard, "Email Address");
                    break;
                case 5:                    retString = getLocale(AspxUserDashBoard, "Integer Number");
                    break;
                case 6:                    retString = getLocale(AspxUserDashBoard, "Price error");
                    break;
                case 7:                    retString = getLocale(AspxUserDashBoard, "Web URL");
                    break;
            }
            return retString;
        },
        ...
        DeleteCVImage: function(onjImg) {            var $target = $(onjImg).closest('tr');
        ...
        SaveItem: function(formID, attributeSetId, itemTypeId, itemId) {
            ...
            $("#multipleUpload .classTableWrapper > tbody >tr").each(function() {
                ...
                var relatedItems_ids = SageData.Get("gdvRelatedItems").Arr.join(',');
...
//                });
                ...
                var upSellItems_ids = SageData.Get("gdvUpSellItems").Arr.join(',');
...
//                });
                ...
                var crossSellItems_ids = SageData.Get("gdvCrossSellItems").Arr.join(',');
