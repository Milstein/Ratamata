...
<div id="divOrderDetails" class="sfFormwrapper">
 ...
 <li>
    ...
    <div class="cssClassServiceDetails" style="display: none">
        <ul>
            <li>
                <h4><span class="sfLocale">Service Details:</span></h4>
            </li>
            <li>
                <label class="sfLocale">Service Name:</label><span class="cssClassLabel" id="serviceName"></span>
                ...
                <table class="sfGridWrapperTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <thead>
                        <tr class="cssClassHeading">
                            <td class="sfLocale">Item Name
                            </td>
                            <td class="sfLocale">SKU
                            </td>
                            <td class="sfLocale">Shipping Address
                            </td>
                            <td class="sfLocale">Shipping Rate
                            </td>
                            <td class="sfLocale">Price
                            </td>
                            <td class="cssClassQtyTbl sfLocale">Quantity
                            </td>
                            <td class="cssClassSubTotalTbl sfLocale">Sub Total
                            </td>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <div class="sfButtonwrapper">
        <label class="cssClassDarkBtn i-arrow-left"><button type="button" id="lnkBack" class="sfBtn">
