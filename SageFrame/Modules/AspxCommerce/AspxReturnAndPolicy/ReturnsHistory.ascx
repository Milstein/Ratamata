    ...
    <div class="cssClassReturnInfo clearfix cssClassBMar30">
        <ul>
            <li><span class="cssClassLabel sfLocale cssClassRMar5">Return ID: </span><span class="cssClassLabel sfLocale"
                id="spanReturnID"></span>
            </li>

            <li><span class="cssClassLabel sfLocale cssClassRMar5">Return
            Filed Date: </span><span class="cssClassLabel sfLocale" id="spanReturnFiledDate"></span></li>

            <li><span class="cssClassLabel sfLocale cssClassRMar5">Order ID: </span><span class="cssClassLabel sfLocale"
                id="spanOrderID"></span></li>
            <li><span class="cssClassLabel sfLocale cssClassRMar5">Order
            Date: </span><span class="cssClassLabel sfLocale" id="spanOrderedDateDate"></span></li>
        </ul>
    </div>
...
<div id="divReturnInfo" class="sfFormwrapper">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2 class="sfLocale">Item Return Information:</h2>
        </div>
                    ...
                    <thead>
                        <tr class="cssClassHeading">
                           ...
                           <td class="header sfLocale">
                            ...
                            <td class="sfLocale"><strong>Variants
                            </strong></td>
                            <td class="sfLocale"><strong>Qty.
                            </strong></td>
                            <td class="sfLocale"><strong>Reson For Return
                            </strong></td>
                            <td class="sfLocale"><strong>Other Faults
                            </strong></td>
                            <td class="sfLocale"><strong>Item Condition
                            </strong></td>
                            <td class="sfLocale"><strong>Return Staus
                            </strong></td>
                            <td class="sfLocale"><strong>Return Action
                            </strong></td>
                        </tr>
                    </thead>
                    <tbody>
...
<div id="divSaveComments">
    <div class="cssClassCommonBox Curve">
        ...
        <div class="sfFormwrapper">
            <div id="divComments">
                <div>
                    <span id="spanPostComments" class="cssClassspanPostComments sfLocale"><b>PostComments :</b></span>
                </div>
                ...
                <div class="cssClassTMar20 cssClassBMar20">
                    <span id="spanSaveComments" class="cssClassspanSaveComments">
                        <label class="cssClassGreenBtn i-bubbles">
                            <button type="button" id="btnSaveComments" class="cssClassButtonSubmit"><span class="sfLocale">Post Comment</span></button></label></span>
                </div>
            </div>
