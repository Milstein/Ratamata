<%@ WebHandler Language="C#" Class="ABTestingHandler" %>
...
public class ABTestingHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.ABTesting.ABTestingController), json, methodName);
