    ...
    $(function() {
        ...
        Setting = {
            ...
            SaveUpdateMoneybookersSetting: function() {
                ...
                var settingValue = '';
                settingValue += $("#txtReturnUrl").val() + "#" + $("#txtBusinessAccount").val() + "#" + $("#txtSecretWord").val() + "#" + $("#txtCurrency").val() + "#" + $("#txtVerificationUrl").val() + "#" + $("#txtCancelUrl").val() + "#" + $("#txtLogoUrl").val() + "#" + $("#chkIsTest").is(':checked');
                var isActive = true;
...
<div class="sfFormwrapper">
    ...
    <div class="sfButtonwrapper">
        <p>
            <button id="btnSaveMoneybookersSetting" type="button" class="sfBtn">
