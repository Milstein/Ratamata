                    ...
                    case 1:                        
                        ...
                        $.each(data.d, function(index, value) {
                            ...
                            if (index < 1) {
                                ...
                                billAdd += '<li><h4>' + getLocale(AspxGiftCard, "Billing Address :") + '</h4></li>';
                            ...
                            if (index == 0) {
                                subTotal = '<tr>';
                                subTotal += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Sub Total :") + '</b></td>';
                                        ...
                                        $.each(msg.d, function(index, val) {
                                            if (val.TaxSubTotal != 0) {
                                                ...
                                                taxTotal += '</tr>';
                                                                                                                                                                ...
                                                                                                                                                                shippingCost = '<tr>';
                                shippingCost += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Shipping Cost :") + '</b></td>';
                                ...
                                shippingCost += '</tr>';
                                discountAmount = '<tr>';
                                discountAmount += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Discount Amount :") + '</b></td>';
                                ...
                                discountAmount += '</tr>';
                                couponAmount = '<tr>';
                                couponAmount += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Coupon Amount :") + '</b></td>';
                                ...
                                rewardAmount = '<tr>';
                                rewardAmount += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Discount ( Reward Points ) :") + '</b></td>';
                                ...
                                rewardAmount += '</tr>';
                                    ...
                                    for (var g = 0; g < giftCardUsed.length; g++) {
                                        ...
                                        giftCard += '<tr>';
                                        giftCard += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Gift Card") + '(' + keyVal[0] +
                                        ') :</b></td>';
                                ...
                                grandTotal += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(AspxGiftCard, "Grand Total :") + '</b></td>';
                        ...
                        if (additionalNote != '' && additionalNote != undefined) {
                            $(".remarks").html("").html(getLocale(AspxGiftCard, "*Additional Note :- ") + "'" + additionalNote + "'");
                        } else {
                            $(".remarks").html("");
                        }
...
<div class="cssClassTMar20 cssClassBMar20">
            ...
            <td class="LabelColInfo1R">
                        <span><strong class="sfLocale">Invoice Number:</strong></span>
                    </td>
            ...
            <div class="sfButtonwrapper">
               <!--<label class="cssClassDarkBtn"> <asp:HyperLink ID="hlnkHomePage" runat="server" meta:resourcekey="hlnkHomePageResource1">Back to Home page</asp:HyperLink></label>-->
                <label class="cssClassOrangeBtn"><button id="btnPrint" type="button">
