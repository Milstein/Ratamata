$(function () {
    ...
    customersManagement = {
        ...
        BindCustRecentOrders: function () {
            ...
            var offset_ = 1;
            var current_ = 1;
            var perpage = ($("#gdvCustRecentOrders_pagesize").length > 0) ? $("#gdvCustWishlist_pagesize :selected").text() : 10;
        ...
        init: function (config) {
            ...
            $('#btnDeleteSelectedShop').click(function () {
                var SelectedShopIDs = '';
                               $("#gdvCustShoppCartDetails .attrChkbox").each(function (i) {
                    if ($(this).prop("checked")) {
                        SelectedShopIDs += $(this).val() + ',';
                    }
                });
                if (SelectedShopIDs != "") {
                    var properties = {
            ...
            $('#btnDeleteSectedWish').click(function () {
                var WishListIDs = '';
                               $("#gdvCustWishlist .attrChkbox").each(function (i) {
                    if ($(this).prop("checked")) {
                        WishListIDs += $(this).val() + ',';
                    }
                });
                if (WishListIDs != "") {
                    var properties = {
