    ...
    $(function () {
        ...
        RewardPointsSetting = {
            ...
            ajaxCall: function (config) {
                $.ajax({
                    type: RewardPointsSetting.config.type,
    ...
    <div id="dvAddNewRewardPoints" style="display: none;">
        <div class="cssClassCommonBox Curve">
            <div class="cssClassHeader">
                <h3>
                    <asp:Label ID="lblNewRewardPoint" runat="server" Text="Add New Reward Rule :"
                        meta:resourcekey="lblNewRewardPointResource1"></asp:Label>
                </h3>
            </div>
                ...
                <div class="sfGridWrapperContent">
                    <table id="tblNewEwardPoint" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtRewardRuleName" name="RewardRuleNm" class="sfInputbox required" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <select id="selectRewardRule" name="RewardRule" class="sfListmenu required">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtRwrdPoints" name="RwrdPoints" class="sfInputbox required number"
                        ...
                        <tr id="trAmount" style="display: none;">
                            ...
                            <td>
                                <input type="text" id="txtPurchaseAmount" name="purchase" class="sfInputbox required number" />
                            </td>
                        </tr>
                        <tr>
                            <td>
